...
CrateApp::CrateApp(wxWindow* parent, wxWindowID id, const wxString& title,
	...
	MessageLabel->Wrap(-1);
	bSizer112->Add(MessageLabel, 0, wxALIGN_CENTER_VERTICAL | wxALL | wxEXPAND,
			5);
	...
	OptionScrollWindow = new wxScrolledWindow(this, wxID_ANY, wxDefaultPosition,
			wxDefaultSize, wxHSCROLL | wxVSCROLL);
	OptionScrollWindow->SetScrollRate(0, 10);
	OptionScrollWindow->SetMaxSize( wxSize( 230,610 ) );
	...
	AmountOfObjectsLabel = new wxStaticText(OptionScrollWindow, wxID_ANY,
			wxT("Amount Of Crates"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_staticText29 = new wxStaticText(OptionScrollWindow, wxID_ANY,
			wxT("Box Color:"), wxDefaultPosition, wxDefaultSize, 0);
	m_staticText29->Wrap(-1);
	bSizer121102->Add(m_staticText29, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	ColorSlider = new wxSlider(OptionScrollWindow, wxID_ANY, 0, 0, 255,
			wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL);
	bSizer121102->Add(ColorSlider, 1, wxALL, 5);

	bSizer1211->Add(bSizer121102, 0, wxEXPAND, 5);

	m_staticline1 = new wxStaticLine(OptionScrollWindow, wxID_ANY,
			wxDefaultPosition, wxSize(-1, 1), wxLI_HORIZONTAL);
	...
	m_staticline2 = new wxStaticLine(OptionScrollWindow, wxID_ANY,
			wxDefaultPosition, wxSize(-1, 1), wxLI_HORIZONTAL);
	...
	m_staticline21 = new wxStaticLine(OptionScrollWindow, wxID_ANY,
			wxDefaultPosition, wxSize(-1, 1), wxLI_HORIZONTAL);
	bSizer1211->Add(m_staticline21, 0, wxEXPAND | wxALL, 5);

	LineRDB = new wxRadioButton(OptionScrollWindow, wxID_ANY, wxT("Line"),
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer1211->Add(LineRDB, 0, wxALL | wxEXPAND, 5);

	wxBoxSizer* bSizer48;
	bSizer48 = new wxBoxSizer(wxHORIZONTAL);

	QRCodeCornerRDB = new wxRadioButton(OptionScrollWindow, wxID_ANY,
			wxT("QR code corner"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer48->Add(QRCodeCornerRDB, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	QRCodeCornerLabel = new wxStaticText(OptionScrollWindow, wxID_ANY,
			wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
	QRCodeCornerLabel->Wrap(-1);
	QRCodeCornerLabel->SetMinSize(wxSize(70, -1));

	bSizer48->Add(QRCodeCornerLabel, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	bSizer1211->Add(bSizer48, 0, wxEXPAND, 5);

	wxBoxSizer* bSizer481;
	bSizer481 = new wxBoxSizer(wxHORIZONTAL);

	OppositeCornerRDB = new wxRadioButton(OptionScrollWindow, wxID_ANY,
			wxT("Opposite corner"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer481->Add(OppositeCornerRDB, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	OppositeCornerLabel = new wxStaticText(OptionScrollWindow, wxID_ANY,
			wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
	OppositeCornerLabel->Wrap(-1);
	OppositeCornerLabel->SetMinSize(wxSize(70, -1));

	bSizer481->Add(OppositeCornerLabel, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	bSizer1211->Add(bSizer481, 0, wxEXPAND, 5);

	m_staticline12 = new wxStaticLine(OptionScrollWindow, wxID_ANY,
			wxDefaultPosition, wxSize(-1, 1), wxLI_HORIZONTAL);
	...
	ImageField->Connect(wxEVT_LEAVE_WINDOW,
			wxMouseEventHandler( CrateApp::OnLeaveImageField ), NULL, this);
	ImageField->Connect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateApp::OnLeftMousePressed ), NULL, this);
	ImageField->Connect(wxEVT_LEFT_UP,
			wxMouseEventHandler( CrateApp::OnLeftMouseRelease ), NULL, this);
	ImageField->Connect(wxEVT_MOTION,
			wxMouseEventHandler( CrateApp::OnImageMotion ), NULL, this);
	ColorSlider->Connect(wxEVT_SCROLL_TOP,
			wxScrollEventHandler( CrateApp::OnColorSlider ), NULL, this);
	...
	ColorSlider->Connect(wxEVT_SCROLL_CHANGED,
			wxScrollEventHandler( CrateApp::OnColorSlider ), NULL, this);
	ZoomBox_radioBtn->Connect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateApp::OnZoomRadioButton ), NULL, this);
	ZoomCheckBox->Connect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateApp::OnZoomChange ), NULL, this);
	ZoomButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
			wxCommandEventHandler( CrateApp::OnZoom ), NULL, this);
	OriginalImageButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
			wxCommandEventHandler( CrateApp::OnOriginal ), NULL, this);
	NextObjectButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
			wxCommandEventHandler( CrateApp::OnNextObjectButton ), NULL, this);
	SkipButton->Connect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateApp::OnSkip ), NULL, this);
	ResetButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
			wxCommandEventHandler( CrateApp::OnReset ), NULL, this);
	DoneButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
			wxCommandEventHandler( CrateApp::OnDoneButton ), NULL, this);
}
