...
GUIFrame::GUIFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer121->Add( SurroundBox_radioBtn, 0, wxALL, 5 );
	...
	CenterLine_radioBtn = new wxRadioButton( this, wxID_ANY, wxT("Center line"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	CenterTop_RadioBtn = new wxRadioButton( this, wxID_ANY, wxT("Center Top"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer121->Add( NextObjectButton, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	SkipButton = new wxButton( this, wxID_ANY, wxT("Skip"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer121->Add( SkipButton, 0, wxALL, 5 );
