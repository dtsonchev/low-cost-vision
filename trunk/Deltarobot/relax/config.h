 ...
 * Modbus constants.
 */
const int MODBUS_MAX_PROC_TIME  = 8000;  // in usec
const int MODBUS_MAX_BCAST_TIME = 14000;  // in usec
const int MODBUS_TIMEOUT_BEGIN  = 150000; // in usec
const int MODBUS_TIMEOUT_END    = 150000;
