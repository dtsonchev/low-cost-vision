...
GUIFrame::GUIFrame(wxWindow* parent, wxWindowID id, const wxString& title,
	...
	MessageLabel->Wrap(-1);
	bSizer112->Add(MessageLabel, 1, wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL,
			5);
	...
	AmountOfObjectsLabel = new wxStaticText(this, wxID_ANY,
			wxT("Amount Of Objects"), wxDefaultPosition, wxDefaultSize, 0);
	AmountOfObjectsLabel->Wrap(-1);
	bSizer1211->Add(AmountOfObjectsLabel, 0, wxALL | wxALIGN_CENTER_VERTICAL,
			5);

	AmountOfObjectsTxtField = new wxTextCtrl(this, wxID_ANY, wxEmptyString,
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer1211->Add(AmountOfObjectsTxtField, 0, wxALL | wxALIGN_CENTER_VERTICAL,
			5);
	...
	BackgroundTextField = new wxStaticText(this, wxID_ANY,
	...
	filePicker =
			new wxFilePickerCtrl(
					...
					wxEmptyString,
					wxT("Select a file"),
					wxT("PNG files(*.png;*.PNG)|*.png;*.PNG|JPG files (*.jpg;*.JPG)|*.JPG"),
	...
	BackgroundComboBox = new wxComboBox(this, wxID_ANY, wxT("Background"),
			wxDefaultPosition, wxSize(-1, -1), 0, NULL, wxCB_READONLY);
	bSizer121->Add(BackgroundComboBox, 0, wxALL | wxEXPAND, 5);

	LightingComboBox = new wxComboBox(this, wxID_ANY, wxT("Light"),
			wxDefaultPosition, wxSize(-1, -1), 0, NULL, wxCB_READONLY);
	bSizer121->Add(LightingComboBox, 0, wxALL | wxEXPAND, 5);

	PerspectiveComboBox = new wxComboBox(this, wxID_ANY, wxT("Perspective"),
			wxDefaultPosition, wxSize(-1, -1), 0, NULL, wxCB_READONLY);
	bSizer121->Add(PerspectiveComboBox, 0, wxALL | wxEXPAND, 5);

	bSizer121->Add(
			new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxSize(-1, 1),
					wxLI_HORIZONTAL), 0, wxALL | wxEXPAND, 5);

	ObjectComboBox = new wxComboBox(this, wxID_ANY, wxT("Object"),
			wxDefaultPosition, wxSize(-1, -1), 0, NULL, wxCB_READONLY);
	bSizer121->Add(ObjectComboBox, 0,
			wxALL | wxALIGN_CENTER_VERTICAL | wxEXPAND, 5);

	wxBoxSizer* bSizer1221;
	bSizer1221 = new wxBoxSizer(wxHORIZONTAL);

	SurroundBox_radioBtn = new wxRadioButton(this, wxID_ANY,
			wxT("Surround box"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer1221->Add(SurroundBox_radioBtn, 1, wxALL | wxALIGN_CENTER_VERTICAL,
			5);

	CrateButton = new wxButton(this, wxID_ANY, wxT("Crate"), wxDefaultPosition,
			wxDefaultSize, 0);
	...
	LUC_RadioBtn = new wxRadioButton(this, wxID_ANY, wxT("Left Upper Corner"),
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer1213->Add(LUC_RadioBtn, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	LUC_Label = new wxStaticText(this, wxID_ANY, wxT("(000, 000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	LUC_Label->Wrap(-1);
	...
	RLC_RadioBtn = new wxRadioButton(this, wxID_ANY, wxT("Right Lower Corner"),
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer1214->Add(RLC_RadioBtn, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	RLC_Label = new wxStaticText(this, wxID_ANY, wxT("(000, 000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	RLC_Label->Wrap(-1);
	...
	CenterLine_radioBtn = new wxRadioButton(this, wxID_ANY,
			wxT("Rotation line"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer1215->Add(CenterLine_radioBtn, 1, wxALL, 5);

	NoRotationCheckBox = new wxCheckBox(this, wxID_ANY, wxT("No Rotation"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	CenterTop_RadioBtn = new wxRadioButton(this, wxID_ANY, wxT("Rotation Top"),
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer1216->Add(CenterTop_RadioBtn, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	CenterTop_Label = new wxStaticText(this, wxID_ANY, wxT("(000, 000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	CenterBottom_RadioBtn = new wxRadioButton(this, wxID_ANY,
			wxT("Rotation Bottom"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer1217->Add(CenterBottom_RadioBtn, 1, wxALL | wxALIGN_CENTER_VERTICAL,
			5);

	CenterBottom_Label = new wxStaticText(this, wxID_ANY, wxT("(000, 000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	bSizer121->Add(
			new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxSize(-1, 1),
					wxLI_HORIZONTAL), 0, wxEXPAND | wxALL, 5);

	wxBoxSizer* bSizer1218;
	bSizer1218 = new wxBoxSizer(wxHORIZONTAL);

	Rotation_Label = new wxStaticText(this, wxID_ANY, wxT("Rotation (degrees)"),
			wxDefaultPosition, wxDefaultSize, 0);
	Rotation_Label->Wrap(-1);
	bSizer1218->Add(Rotation_Label, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	RotationValue_label = new wxStaticText(this, wxID_ANY, wxT("360.0"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	CenterPoint_label = new wxStaticText(this, wxID_ANY, wxT("Center point"),
			wxDefaultPosition, wxDefaultSize, 0);
	CenterPoint_label->Wrap(-1);
	bSizer1219->Add(CenterPoint_label, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

	CenterPointValue_label = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	CenterPointValue_label->Wrap(-1);
	bSizer1219->Add(CenterPointValue_label, 0, wxALL | wxALIGN_CENTER_VERTICAL,
			5);
	...
	NextObjectButton = new wxButton(this, wxID_ANY, wxT("Next Object"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	bSizer1220->Add(bSizer411, 1, wxEXPAND, 5);

	SkipButton = new wxButton(this, wxID_ANY, wxT("Skip"), wxDefaultPosition,
			wxDefaultSize, 0);
	...
	ResetButton = new wxButton(this, wxID_ANY, wxT("Reset image"),
			wxDefaultPosition, wxDefaultSize, 0);
	bSizer40->Add(ResetButton, 0, wxALL, 5);
	...
	DoneButton = new wxButton(this, wxID_ANY, wxT("Done"), wxDefaultPosition,
			wxDefaultSize, 0);
	bSizer40->Add(DoneButton, 0, wxALL, 5);

	bSizer121->Add(bSizer40, 1, wxEXPAND, 5);

	bSizer12->Add(bSizer121, 1, wxEXPAND | wxALIGN_RIGHT, 5);
	...
	AmountOfObjectsTxtField->Connect(wxEVT_KILL_FOCUS,
			wxFocusEventHandler( GUIFrame::OnAmountOfObjects ), NULL, this);
...
GUIFrame::~GUIFrame() {
	...
	AmountOfObjectsTxtField->Disconnect(wxEVT_KILL_FOCUS,
			wxFocusEventHandler( GUIFrame::OnAmountOfObjects ), NULL, this);
