...
CrateGUI::CrateGUI(wxWindow* parent, wxWindowID id, const wxString& title,
	...
	LT_Radio = new wxRadioButton(this, wxID_ANY, wxT("Left top marker"),
			wxDefaultPosition, wxDefaultSize, 0);
	LT_Radio->SetForegroundColour(wxColour(255, 0, 0));
	bSizer121->Add(LT_Radio, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

	wxBoxSizer* bSizer1211;
	bSizer1211 = new wxBoxSizer(wxHORIZONTAL);

	LTLTCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("LTCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	LTLTCorner_Radio->SetForegroundColour(wxColour(255, 0, 0));
	bSizer1211->Add(LTLTCorner_Radio, 0, wxALL | wxALIGN_RIGHT, 5);

	LTRLCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("RLCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	LTRLCorner_Radio->SetForegroundColour(wxColour(255, 0, 0));
	...
	LTLT_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	LTLT_TxtField->SetForegroundColour(wxColour(255, 0, 0));
	...
	LTRB_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	LTRB_TxtField->SetForegroundColour(wxColour(255, 0, 0));
	...
	bSizer121->Add(
			new wxStaticLine(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
	...
	RT_Radio = new wxRadioButton(this, wxID_ANY, wxT("Right top marker"),
			wxDefaultPosition, wxDefaultSize, 0);
	RT_Radio->SetForegroundColour(wxColour(11, 111, 11));
	bSizer122->Add(RT_Radio, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

	wxBoxSizer* bSizer1221;
	bSizer1221 = new wxBoxSizer(wxHORIZONTAL);

	RTLTCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("LTCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	RTLTCorner_Radio->SetForegroundColour(wxColour(11, 111, 11));
	bSizer1221->Add(RTLTCorner_Radio, 0, wxALL | wxALIGN_RIGHT, 5);

	RTRLCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("RLCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	RTRLCorner_Radio->SetForegroundColour(wxColour(11, 111, 11));
	...
	RTLT_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	RTLT_TxtField->SetForegroundColour(wxColour(11, 111, 11));
	...
	RTRB_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	RTRB_TxtField->SetForegroundColour(wxColour(11, 111, 11));
	...
	LB_Radio = new wxRadioButton(this, wxID_ANY, wxT("Left bottom marker"),
			wxDefaultPosition, wxDefaultSize, 0);
	LB_Radio->SetForegroundColour(wxColour(0, 0, 255));
	bSizer1224->Add(LB_Radio, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

	wxBoxSizer* bSizer12241;
	bSizer12241 = new wxBoxSizer(wxHORIZONTAL);

	LBLTCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("LTCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	LBLTCorner_Radio->SetForegroundColour(wxColour(0, 0, 255));
	bSizer12241->Add(LBLTCorner_Radio, 0, wxALL | wxALIGN_RIGHT, 5);

	LBRLCorner_Radio = new wxRadioButton(this, wxID_ANY, wxT("RLCorner"),
			wxDefaultPosition, wxDefaultSize, 0);
	LBRLCorner_Radio->SetForegroundColour(wxColour(0, 0, 255));
	...
	LBLT_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	LBLT_TxtField->SetForegroundColour(wxColour(0, 0, 255));
	...
	LBRB_TxtField = new wxStaticText(this, wxID_ANY, wxT("(000,000)"),
			wxDefaultPosition, wxDefaultSize, 0);
	LBRB_TxtField->SetForegroundColour(wxColour(0, 0, 255));
	...
	bSizer12->Add(m_staticText26, 0, wxALL, 5);

	QRCode_TxtField = new wxTextCtrl(this, wxID_ANY, wxT("QR code"),
			wxDefaultPosition, wxDefaultSize, 0);
	...
	pathField = new wxStaticText(this, wxID_ANY, wxT("/Path/..."),
			wxDefaultPosition, wxDefaultSize, 0);
	pathField->Wrap(-1);
	...
	// Connect Events
	this->Connect(wxEVT_SIZE, wxSizeEventHandler( CrateGUI::OnSizeChange ));
	imageField->Connect(wxEVT_LEAVE_WINDOW,
			wxMouseEventHandler( CrateGUI::OnLeftImageField ), NULL, this);
	imageField->Connect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateGUI::OnLeftDown ), NULL, this);
	imageField->Connect(wxEVT_LEFT_UP,
			wxMouseEventHandler( CrateGUI::OnLeftUp ), NULL, this);
	imageField->Connect(wxEVT_MOTION,
			wxMouseEventHandler( CrateGUI::OnLeftMotion ), NULL, this);
	DONE_button->Connect(wxEVT_LEFT_DOWN,
...
CrateGUI::~CrateGUI() {
	...
	// Disconnect Events
	this->Disconnect(wxEVT_SIZE, wxSizeEventHandler( CrateGUI::OnSizeChange ));
	...
	imageField->Disconnect(wxEVT_MOTION,
			wxMouseEventHandler( CrateGUI::OnLeftMotion ), NULL, this);
	DONE_button->Disconnect(wxEVT_LEFT_DOWN,
			wxMouseEventHandler( CrateGUI::OnDonePressed ), NULL, this);
